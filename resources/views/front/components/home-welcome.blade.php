<div class="card mb-2">
    <div class="card-header">
        <div class="row">
            <div class="col-11"> {{ __('Welcome') }}... Universidad Centroccidental "Lisandro Alvarado" - UCLA</div>
    ...
    <div class="card-body p-0">
        <img src="{{ asset('img/administration.jpg') }}" alt="Administración" class="d-block w-100" />
    </div>
