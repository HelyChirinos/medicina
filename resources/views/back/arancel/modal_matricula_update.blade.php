                ...
                <div class="card mb-2">
                    ...
                    <div class="card-body">
                        ...
                        <div class="row mb-2">
                            ...
                            <div class="col-md-8">
                                <input id="montov" name="montov" type="numeric" placeholder="Monto en $"  class="form-control @error('montov') is-invalid @enderror" value="{{$matricula->monto_venezolano}}" required >
                        ...
                        <div class="row mb-2">
                            ...
                            <div class="col-md-8">
                                ...
                                class="form-control @error('montoe') is-invalid @enderror" value="{{$matricula->monto_extranjero}}" required >
