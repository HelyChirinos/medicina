...
class AppServiceProvider extends ServiceProvider
{
     ...
     * se coloca el path real del Public_HTML
     */
    ...
    public function boot(): void
    {
        ...
        //Propietarios only
        // -----------------------------------------------------------------------
        Gate::define('propietario', function ($user) {
            return $user->is_propietario;
        });

        // -----------------------------------------------------------------------
        // Log Viewer : grant access (in production) to Propietarios
        // -----------------------------------------------------------------------
        LogViewer::auth(function ($request) {
            return auth()->user() && auth()->user()->is_propietario;
        });
